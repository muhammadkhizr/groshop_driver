...
import 'package:gromartdriver/ui/resetPasswordScreen/ResetPasswordScreen.dart';
...
class _LoginScreen extends State<LoginScreen> {
  ...
  _loginWithEmailAndPassword(String email, String password) async {
    ...
    if (result != null && result is User && result.role == USER_ROLE_DRIVER) {
      ...
      showAlertDialog(context, 'couldntAuthenticate'.tr(), result, true);
    } else {
      showAlertDialog(context, 'couldntAuthenticate'.tr(), 'loginFailed,PleaseTryAgain.'.tr(), true);
    }
  }
