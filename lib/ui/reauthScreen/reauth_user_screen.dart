          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'pleaseRe-AuthenticateInOrderToPerformThisAction'.tr(),
    ...
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || (snapshot.data != true)) {
          return Center(child: Text('appleSignInIsNotAvailableOnThisDevice'.tr()));
        } else {
  ...
  passwordButtonPressed() async {
    if (_passwordController.text.isEmpty) {
      showAlertDialog(
        context,
        'emptyPassword'.tr(),
        'passwordIsRequiredToUpdateEmail'.tr(),
        true,
      );
    } else {
      ...
      try {
        ...
        if (result == null) {
          ...
          showAlertDialog(
            context,
            'couldntVerify'.tr(),
            'pleaseDoubleCheckThePasswordAndTryAgain'.tr(),
            true,
          );
        } else {
          if (result.user != null) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  'couldntVerify,PleaseTryAgain'.tr(),
  ...
  void _submitCode(String code) async {
    ...
    try {
      ...
      switch (exception.code) {
        ...
        default:
          message = 'anErrorHasOccurred,PleaseTryAgain.'.tr();
          message = exception.message??'anErrorHasOccurred,PleaseTryAgain.'.tr();
          break;
      }
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
