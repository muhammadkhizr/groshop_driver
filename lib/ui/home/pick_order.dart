                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                        fontFamily: 'Poppinsr', letterSpacing: 0.5, color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(0xff333333)),
                                  ),
                                  SizedBox(height: 5),
                                  Row(
                                    children: [
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              primary: _value ? Color(COLOR_PRIMARY) : Color(COLOR_PRIMARY).withOpacity(0.5),
            ),
            child: Text(
              "pickedOrder".tr().toUpperCase(),
              style: TextStyle(letterSpacing: 0.5),
            ),
            onPressed: () => _value ? Navigator.pop(context) : null,
          ),
        ),
      ),
    );
