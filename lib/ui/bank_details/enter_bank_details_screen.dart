  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.isNewAccount ? "addBank".tr() : "editBank".tr(),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                buildTextFiled(validator: validateName, title: "bankName".tr(), controller: bankNameController),
                buildTextFiled(validator: validateOthers, title: "branchName".tr(), controller: branchNameController),
                buildTextFiled(validator: validateOthers, title: "holderName".tr(), controller: holderNameController),
                buildTextFiled(validator: validateOthers, title: "accountNumber".tr(), controller: accountNoController),
                buildTextFiled(validator: (String? value) {}, title: "otherInformation".tr(), controller: otherInfoController),
                Padding(
