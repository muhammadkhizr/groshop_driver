...
import 'package:gromartdriver/ui/accountDetails/AccountDetailsScreen.dart';
import 'package:gromartdriver/ui/auth/AuthScreen.dart';
import 'package:gromartdriver/ui/contactUs/ContactUsScreen.dart';
import 'package:gromartdriver/ui/reauthScreen/reauth_user_screen.dart';
import 'package:gromartdriver/ui/settings/SettingsScreen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _imagePicked(File image, bool isUserImage) async {
    showProgress(context, isUserImage ? 'uploadingImage'.tr() : 'uploadingCarImage'.tr(), false);
    if (isUserImage)
